# OpenScience_task
Creating a repo following the instructions from the Open Science Software course

**Took it directly from the [course readme](https://github.com/OpenScienceMOOC/Module-5-Open-Research-Software-and-Open-Source/edit/master/README.md)**
...
**Cite this test repo as:**  

Cristian Mejia. “Cristianmejia00/openscience_task: First Release”. Zenodo, June 4, 2019. doi:10.5281/zenodo.3237970.

**The Zenodo badge**  

[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.3237970.svg)](https://doi.org/10.5281/zenodo.3237970)

**Adding this line**  
**yet another line**  
**Still asks for my password**  
**More testing**  
**Good, seems is finally working**  
**No. Now it asks for the passphrase instead**  
**My bad. I set the passphrase, which is optional. Now I deleted it**  
**Now working beautifully**  
**The last part of this tutorial helped to solve the issue in Windows:**  
**We have to change [remote.origin.url from HTTPS to HTTP](https://www.r-bloggers.com/rstudio-pushing-to-github-with-ssh-authentication/)**  



**Making changes in RStudio**  
Now I'm working in RStudio.
